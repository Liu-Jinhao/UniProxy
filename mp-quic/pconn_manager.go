...
func (pcm *pconnManager) createPconns() error {
	...
	for _, i := range ifaces {
		...
		if !strings.Contains(i.Name, "eth") && !strings.Contains(i.Name, "rmnet") && !strings.Contains(i.Name, "wlan") && !strings.Contains(i.Name, "enp") && !strings.Contains(i.Name, "enx") && !strings.Contains(i.Name, "wlp") {
			continue
		}
		addrs, err := i.Addrs()
		if err != nil {
